...
pub fn registry(device_id: &str) -> Vec<Feature> {
    ...
    let mut features = vec![
        ...
        s(
            "steam_downloads",
            "Steam Updating",
            "On while Steam is downloading or updating a game.",
            Games,
            true,
            Running,
            "on",
            ...
            "",
            "Watches Steam's appmanifest .acf files for the download/update flag. On/off only - no live percentage (a CEF-based live % was researched but is not implemented).",
        ),
        a(
            "launch_game",
            "Launch Game",
